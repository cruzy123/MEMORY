    ...
    <div class="container-fluid p-3">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <ol class="breadcrumb bg-primary col-md-12">
                ...
                <li class="breadcrumb-item text-light"><a class="text-light " style="text-decoration:none;!important" href="/demandes">Rejet de demande</a></li>
            </ol>    
        </div>
        ...
        <div class="row justify-content-center"> 
            <div class="card col-md-6 p-2 m-2" >
                <img src="" alt="">
                <div class="card-body">
                    <h5 class="card-title">Paramètres de rejet ( Email à envoyer )</h5><hr>
                    <div class="p-3">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-12">
                                <button id="validate" onclick="submitFormAjax();" type="button" class="btn btn-primary p-3">Rejeter la demande <i class="fa fa-rocket"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (val[0] == "true") {
                        ...
                        toastr.error(val[1]);
                        $('#validate').html('Rejeter la demande <i class="fa fa-rocket"></i>')
                    }
                }
            });
        }
